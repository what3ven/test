...
class __TwigTemplate_610b1ccb23d0b16d991dcd10e08990d5 extends Template
{
    private $source;
    private $macros = [];
...
{%- block relation_value -%}
    {{- element|render_relation_element(field_description) -}}
{%- endblock -%}
", "@SonataAdmin/CRUD/Association/list_many_to_many.html.twig", "/var/www/html/TestSite/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/Association/list_many_to_many.html.twig");
    }
}
