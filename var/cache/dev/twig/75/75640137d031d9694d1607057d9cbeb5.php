...
class __TwigTemplate_71cd18a3b91fec2dc0677575651deb6b extends Template
{
    private $source;
    private $macros = [];
...
{%- apply spaceless %}
    ...
    {%- endif -%}
{% endapply -%}
", "@SonataAdmin/CRUD/display_datetime.html.twig", "/var/www/html/TestSite/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/display_datetime.html.twig");
    }
}
