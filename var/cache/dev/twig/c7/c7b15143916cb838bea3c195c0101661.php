...
class __TwigTemplate_06d0924224bd8fba6eaa87b4a985ff1e extends Template
{
    private $source;
    private $macros = [];
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/notifier.html.twig", "/var/www/html/TestSite/vendor/symfony/web-profiler-bundle/Resources/views/Collector/notifier.html.twig");
    }
}
