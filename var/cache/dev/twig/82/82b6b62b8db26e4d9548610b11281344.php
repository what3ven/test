...
class __TwigTemplate_be85bd4580c4b0a55eed796bc83af512 extends Template
{
    private $source;
    private $macros = [];
...
{%- apply spaceless %}
    {{ value.name }}
{% endapply -%}
", "@SonataAdmin/CRUD/display_enum.html.twig", "/var/www/html/TestSite/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/display_enum.html.twig");
    }
}
