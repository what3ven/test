...
class XlsxConfig 
{
    ...
    /**
     * add filters in the first line
     * @default true
     * @param ParamConfigurator|bool $value
     * @return $this
     */
    public function showFilters($value): static
    {
        $this->_usedProperties['showFilters'] = true;
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('show_filters', $value)) {
            $this->_usedProperties['showFilters'] = true;
            $this->showFilters = $value['show_filters'];
            unset($value['show_filters']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['showFilters'])) {
            $output['show_filters'] = $this->showFilters;
        }
